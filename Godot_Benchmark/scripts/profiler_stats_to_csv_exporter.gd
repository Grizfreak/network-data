...
func _ready():
	...
	if OS.get_name() == "Android":
		filename = "/storage/emulated/0/Android/data/com.example.godot_benchmark/files/godot_profiler_stats_%s.csv" % Time.get_datetime_string_from_system()
	else:
		filename = "user://godot_profiler_stats_%s.csv" % Time.get_datetime_string_from_system()
